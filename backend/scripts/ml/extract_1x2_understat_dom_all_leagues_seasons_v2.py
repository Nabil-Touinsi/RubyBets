...
SUMMARY_PATH = OUTPUT_DIR / "104_1x2_understat_dom_all_leagues_seasons_v2_summary.txt"
MATCHES_CSV_PATH = OUTPUT_DIR / "105_1x2_understat_dom_all_leagues_seasons_v2_matches.csv"
BY_SEASON_CSV_PATH = OUTPUT_DIR / "106_1x2_understat_dom_all_leagues_seasons_v2_by_league_season.csv"
ERRORS_CSV_PATH = OUTPUT_DIR / "107_1x2_understat_dom_all_leagues_seasons_v2_errors.csv"
NEXT_ACTION_PATH = OUTPUT_DIR / "108_1x2_understat_dom_all_leagues_seasons_v2_next_action.txt"
...
# Écrit la synthèse globale de l'extraction V2.
def write_summary(
    *,
    ...
    global_status = "V8_DOM_ALL_V2_EMPTY" if not rows else "V8_DOM_ALL_V2_PARTIAL"
    if rows and not warning_results:
        global_status = "V8_DOM_ALL_V2_AVAILABLE"
    ...
    content = f"""RubyBets - ML 1X2 V8 Understat DOM all leagues/seasons V2
104 - Synthese extraction DOM multi-ligues multi-saisons Understat V2
...
- Statut source a mettre a jour : a produire -> realise pour l'extraction DOM Understat multi-ligues multi-saisons V2.
"""
    SUMMARY_PATH.write_text(content, encoding="utf-8")


# Écrit la prochaine action recommandée après extraction V2.
...
Resultat :
L'extraction DOM Playwright V2 a recupere {len(rows)} lignes Understat.
...
1. Controler reports/evidence/ml_training/106_1x2_understat_dom_all_leagues_seasons_v2_by_league_season.csv.
...
"""
        ...
        content = """RubyBets - ML 1X2 V8 Understat DOM all leagues/seasons V2
108 - Prochaine action recommandee
...
# Lance l'extraction globale V2 avec Playwright.
def run_all_leagues_seasons_extraction(
    *,
    ...
    status = "V8_DOM_ALL_V2_AVAILABLE" if all_rows and warnings == 0 else "V8_DOM_ALL_V2_PARTIAL"
    if not all_rows:
        status = "V8_DOM_ALL_V2_EMPTY"

    print("Extraction DOM Understat V2 multi-ligues multi-saisons terminee.")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Extraction DOM Understat V2 multi-ligues multi-saisons pour RubyBets.")
