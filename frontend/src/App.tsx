...
type MultiMatchRecommendationItem = {
  match: Match;
...
type MultiMatchRecommendationResponse = {
  source: string;
  method: string;
  request: {
...
function formatPredictionStatus(value: string) {
  const labels: Record<string, string> = {
...
function formatContextTrend(value: string) {
  const labels: Record<string, string> = {
